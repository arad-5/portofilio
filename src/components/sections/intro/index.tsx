...
const Intro = () => {
    return (
        <section
            className={`${styles.intro} h-[calc(100vh_-_4rem)] max-h-[1000px] p-5 text-left md:p-10`}
        >
            <div className="container m-auto flex h-full flex-col items-center justify-between">
                ...
                <p className={`w-full font-yapari italic md:text-6xl`}>
                    welcome
                </p>
            </div>
        </section>
